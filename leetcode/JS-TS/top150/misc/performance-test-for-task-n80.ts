 ...
 */
function removeDuplicatesSplice(nums: number[]): void {
 ...
 */
function removeDuplicatesTwoPointers(nums: number[]): void {
...
function benchmark() {
    ...
    const nums: number[] = Array.from({ length: 10000 }, (_, i) => Math.floor(i / 100));
